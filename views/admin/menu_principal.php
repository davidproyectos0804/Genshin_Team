...
<body class="text-white flex flex-col">
  ...
  <main class="flex-1 flex flex-col items-center justify-center px-6 text-center z-10">
    ...
    <div class="flex gap-8 w-full max-w-4xl">
      <a href="views/admin/personajes.php" class="flex-1 group p-10 bg-black/50 border border-white/5 rounded-2xl backdrop-blur-xl transition-all duration-300 hover:border-indigo-500/40 hover:bg-indigo-900/10">
